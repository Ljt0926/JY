// ======================================================================
// UART_Bootloadable.v generated from TopDesign.cysch
// 06/01/2015 at 10:27
...
// IDAC_P4_v1_0(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_COMPONENT_NAME=IDAC_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.1, INSTANCE_NAME=CapSense_IDAC1, )
...
module CapSense_CSD_P4_v2_10_2 ;
    ...
    cy_psoc4_csd_v1_0 CSD_FFB (
        ...
        .sense_out(Net_329),
        .amuxa(Net_270));
    defparam CSD_FFB.sensors_count = 3;
	...
	cy_psoc3_pins_v1_10
		#(.id("418f4edb-cd5a-4789-8be0-ea101e551211/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    IDAC_P4_v1_0_0 IDAC2 (
        .Iout(Net_270));

	wire [2:0] tmpOE__Sns_net;
	wire [2:0] tmpFB_2__Sns_net;
	wire [2:0] tmpIO_2__Sns_net;
	wire [0:0] tmpINTERRUPT_0__Sns_net;
	electrical [0:0] tmpSIOVREF__Sns_net;

	cy_psoc3_pins_v1_10
		#(.id("418f4edb-cd5a-4789-8be0-ea101e551211/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		...
		Sns
		 (.oe(tmpOE__Sns_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__Sns_net[2:0]}),
		  .analog({Net_245[2:0]}),
		  .io({tmpIO_2__Sns_net[2:0]}),
	...
	assign tmpOE__Sns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

    IDAC_P4_v1_0_1 IDAC1 (
        .Iout(Net_270));
...
module SCB_P4_v2_0_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("a5450544-d4fb-468c-9332-fbf5a51a48dc/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a5450544-d4fb-468c-9332-fbf5a51a48dc/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module SCB_P4_v2_0_4 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4de6ab17-5f21-42b3-b2cd-5c2783974b67/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4de6ab17-5f21-42b3-b2cd-5c2783974b67/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__GYWD_net;
	wire [0:0] tmpFB_0__GYWD_net;
	wire [0:0] tmpIO_0__GYWD_net;
	wire [0:0] tmpINTERRUPT_0__GYWD_net;
	electrical [0:0] tmpSIOVREF__GYWD_net;

	cy_psoc3_pins_v1_10
		#(.id("2fa22e1a-1e8a-4e65-a0b9-c261e202f32a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		GYWD
		 (.oe(tmpOE__GYWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GYWD_net[0:0]}),
		  .io({tmpIO_0__GYWD_net[0:0]}),
		  .siovref(tmpSIOVREF__GYWD_net),
		  .interrupt({tmpINTERRUPT_0__GYWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GYWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DYWD_net;
	wire [0:0] tmpFB_0__DYWD_net;
	wire [0:0] tmpIO_0__DYWD_net;
	wire [0:0] tmpINTERRUPT_0__DYWD_net;
	electrical [0:0] tmpSIOVREF__DYWD_net;

	cy_psoc3_pins_v1_10
		#(.id("fd6b83c5-3317-4586-a683-09ffe7d5525f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		DYWD
		 (.oe(tmpOE__DYWD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DYWD_net[0:0]}),
		  .io({tmpIO_0__DYWD_net[0:0]}),
		  .siovref(tmpSIOVREF__DYWD_net),
		  .interrupt({tmpINTERRUPT_0__DYWD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DYWD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__K1_net;
	wire [0:0] tmpFB_0__K1_net;
	wire [0:0] tmpIO_0__K1_net;
	wire [0:0] tmpINTERRUPT_0__K1_net;
	electrical [0:0] tmpSIOVREF__K1_net;

	cy_psoc3_pins_v1_10
		#(.id("cb30af05-b354-4003-8fd6-6022bc16ff03"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		K1
		 (.oe(tmpOE__K1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__K1_net[0:0]}),
		  .io({tmpIO_0__K1_net[0:0]}),
		  .siovref(tmpSIOVREF__K1_net),
		  .interrupt({tmpINTERRUPT_0__K1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__K1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CapSense_CSD_P4_v2_10_2 CapSense ();

	wire [0:0] tmpOE__V24V_net;
	wire [0:0] tmpIO_0__V24V_net;
	wire [0:0] tmpINTERRUPT_0__V24V_net;
	electrical [0:0] tmpSIOVREF__V24V_net;
	...
	cy_psoc3_pins_v1_10
		...
		V24V
		 (.oe(tmpOE__V24V_net),
		  .y({1'b0}),
		  .fb({Net_91}),
		  .io({tmpIO_0__V24V_net[0:0]}),
		  .siovref(tmpSIOVREF__V24V_net),
		  .interrupt({tmpINTERRUPT_0__V24V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V24V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_RO3_net;
	wire [0:0] tmpFB_0__LED_RO3_net;
	wire [0:0] tmpIO_0__LED_RO3_net;
	wire [0:0] tmpINTERRUPT_0__LED_RO3_net;
	electrical [0:0] tmpSIOVREF__LED_RO3_net;

	cy_psoc3_pins_v1_10
		#(.id("e2d99bc4-42c7-45d0-ae23-d6808ac2b8bc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_RO3
		 (.oe(tmpOE__LED_RO3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_RO3_net[0:0]}),
		  .io({tmpIO_0__LED_RO3_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_RO3_net),
		  .interrupt({tmpINTERRUPT_0__LED_RO3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_RO3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_RO2_net;
	wire [0:0] tmpFB_0__LED_RO2_net;
	wire [0:0] tmpIO_0__LED_RO2_net;
	wire [0:0] tmpINTERRUPT_0__LED_RO2_net;
	electrical [0:0] tmpSIOVREF__LED_RO2_net;

	cy_psoc3_pins_v1_10
		#(.id("b804a83d-2d4e-4cf1-bf30-6b1c56f60212"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_RO2
		 (.oe(tmpOE__LED_RO2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_RO2_net[0:0]}),
		  .io({tmpIO_0__LED_RO2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_RO2_net),
		  .interrupt({tmpINTERRUPT_0__LED_RO2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_RO2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_RO1_net;
	wire [0:0] tmpFB_0__LED_RO1_net;
	wire [0:0] tmpIO_0__LED_RO1_net;
	wire [0:0] tmpINTERRUPT_0__LED_RO1_net;
	electrical [0:0] tmpSIOVREF__LED_RO1_net;

	cy_psoc3_pins_v1_10
		#(.id("9e5623a2-5575-465d-9b76-6a36875ec5ac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_RO1
		 (.oe(tmpOE__LED_RO1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_RO1_net[0:0]}),
		  .io({tmpIO_0__LED_RO1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_RO1_net),
		  .interrupt({tmpINTERRUPT_0__LED_RO1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_RO1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_FC_net;
	wire [0:0] tmpFB_0__LED_FC_net;
	wire [0:0] tmpIO_0__LED_FC_net;
	wire [0:0] tmpINTERRUPT_0__LED_FC_net;
	electrical [0:0] tmpSIOVREF__LED_FC_net;

	cy_psoc3_pins_v1_10
		#(.id("c75cad4b-1ffa-4979-9d4c-b067db3669e7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_FC
		 (.oe(tmpOE__LED_FC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_FC_net[0:0]}),
		  .io({tmpIO_0__LED_FC_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_FC_net),
		  .interrupt({tmpINTERRUPT_0__LED_FC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_FC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_PP_net;
	wire [0:0] tmpFB_0__LED_PP_net;
	wire [0:0] tmpIO_0__LED_PP_net;
	wire [0:0] tmpINTERRUPT_0__LED_PP_net;
	electrical [0:0] tmpSIOVREF__LED_PP_net;

	cy_psoc3_pins_v1_10
		#(.id("4e19ae5a-d8cf-4bb6-99b2-4a28b4b2ff4e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_PP
		 (.oe(tmpOE__LED_PP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_PP_net[0:0]}),
		  .io({tmpIO_0__LED_PP_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_PP_net),
		  .interrupt({tmpINTERRUPT_0__LED_PP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_PP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v2_0_3 UART_1 (
        .interrupt(Net_117),
        .clock(1'b0));

    SCB_P4_v2_0_4 UART_0 (
        .interrupt(Net_115),
        .clock(1'b0));
	...
	wire [0:0] tmpOE__TestPort_net;
	wire [0:0] tmpFB_0__TestPort_net;
	wire [0:0] tmpIO_0__TestPort_net;
	wire [0:0] tmpINTERRUPT_0__TestPort_net;
	electrical [0:0] tmpSIOVREF__TestPort_net;

	cy_psoc3_pins_v1_10
		#(.id("4a12dbc3-dd24-47ff-af7e-81168f428ab4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TestPort
		 (.oe(tmpOE__TestPort_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TestPort_net[0:0]}),
		  .io({tmpIO_0__TestPort_net[0:0]}),
		  .siovref(tmpSIOVREF__TestPort_net),
		  .interrupt({tmpINTERRUPT_0__TestPort_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TestPort_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__K2_net;
	wire [0:0] tmpFB_0__K2_net;
	wire [0:0] tmpIO_0__K2_net;
	wire [0:0] tmpINTERRUPT_0__K2_net;
	electrical [0:0] tmpSIOVREF__K2_net;

	cy_psoc3_pins_v1_10
		#(.id("bb58d093-3d64-4fe0-bef5-aee39ed58902"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		K2
		 (.oe(tmpOE__K2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__K2_net[0:0]}),
		  .io({tmpIO_0__K2_net[0:0]}),
		  .siovref(tmpSIOVREF__K2_net),
		  .interrupt({tmpINTERRUPT_0__K2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__K2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_BC_net;
	wire [0:0] tmpFB_0__LED_BC_net;
	wire [0:0] tmpIO_0__LED_BC_net;
	wire [0:0] tmpINTERRUPT_0__LED_BC_net;
	electrical [0:0] tmpSIOVREF__LED_BC_net;

	cy_psoc3_pins_v1_10
		#(.id("58350ebb-73e6-4419-8e3f-69073dcb4b8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_BC
		 (.oe(tmpOE__LED_BC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_BC_net[0:0]}),
		  .io({tmpIO_0__LED_BC_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_BC_net),
		  .interrupt({tmpINTERRUPT_0__LED_BC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_BC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_WIFI_net;
	wire [0:0] tmpFB_0__LED_WIFI_net;
	wire [0:0] tmpIO_0__LED_WIFI_net;
	wire [0:0] tmpINTERRUPT_0__LED_WIFI_net;
	electrical [0:0] tmpSIOVREF__LED_WIFI_net;

	cy_psoc3_pins_v1_10
		#(.id("c5e8f27d-9fba-4267-8603-fd4b97b43eee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_WIFI
		 (.oe(tmpOE__LED_WIFI_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_WIFI_net[0:0]}),
		  .io({tmpIO_0__LED_WIFI_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_WIFI_net),
		  .interrupt({tmpINTERRUPT_0__LED_WIFI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_WIFI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_KEY_WIFI_net;
	wire [0:0] tmpFB_0__LED_KEY_WIFI_net;
	wire [0:0] tmpIO_0__LED_KEY_WIFI_net;
	wire [0:0] tmpINTERRUPT_0__LED_KEY_WIFI_net;
	electrical [0:0] tmpSIOVREF__LED_KEY_WIFI_net;

	cy_psoc3_pins_v1_10
		#(.id("63b45b9c-7ba9-4201-99cb-6a3cfb8953a6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_KEY_WIFI
		 (.oe(tmpOE__LED_KEY_WIFI_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_KEY_WIFI_net[0:0]}),
		  .io({tmpIO_0__LED_KEY_WIFI_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_KEY_WIFI_net),
		  .interrupt({tmpINTERRUPT_0__LED_KEY_WIFI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_KEY_WIFI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_KEY_SETTING_net;
	wire [0:0] tmpFB_0__LED_KEY_SETTING_net;
	wire [0:0] tmpIO_0__LED_KEY_SETTING_net;
	wire [0:0] tmpINTERRUPT_0__LED_KEY_SETTING_net;
	electrical [0:0] tmpSIOVREF__LED_KEY_SETTING_net;

	cy_psoc3_pins_v1_10
		#(.id("80832bff-24a5-4d0a-a9d7-3cc1a1af65ed"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_KEY_SETTING
		 (.oe(tmpOE__LED_KEY_SETTING_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_KEY_SETTING_net[0:0]}),
		  .io({tmpIO_0__LED_KEY_SETTING_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_KEY_SETTING_net),
		  .interrupt({tmpINTERRUPT_0__LED_KEY_SETTING_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_KEY_SETTING_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TEST_net;
	wire [0:0] tmpFB_0__TEST_net;
	wire [0:0] tmpIO_0__TEST_net;
	wire [0:0] tmpINTERRUPT_0__TEST_net;
	electrical [0:0] tmpSIOVREF__TEST_net;

	cy_psoc3_pins_v1_10
		#(.id("3e4c26a0-38eb-47fb-9fe0-c84c6f73e4f4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		TEST
		 (.oe(tmpOE__TEST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TEST_net[0:0]}),
		  .io({tmpIO_0__TEST_net[0:0]}),
		  .siovref(tmpSIOVREF__TEST_net),
		  .interrupt({tmpINTERRUPT_0__TEST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TEST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
