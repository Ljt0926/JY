/*******************************************************************************
* File Name: UART_0_SPI_UART_PVT.h
* Version 2.0
*
* Description:
...
***************************************/
    ...
    extern volatile uint8 UART_0_rxBufferInternal[UART_0_RX_BUFFER_SIZE];
...
***************************************/
    ...
    #define UART_0_UartStop() \
        do{                             \
            UART_0_UART_RX_CTRL_REG &= ~UART_0_UART_RX_CTRL_SKIP_START; \
        }while(0)
#else
        #define UART_0_UartStop() do{ /* Does nothing */ }while(0)
