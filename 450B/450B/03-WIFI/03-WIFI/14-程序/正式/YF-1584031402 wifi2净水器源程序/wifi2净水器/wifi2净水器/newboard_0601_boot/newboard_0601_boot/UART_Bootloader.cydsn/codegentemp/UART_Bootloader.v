// ======================================================================
// UART_Bootloader.v generated from TopDesign.cysch
// 05/14/2015 at 19:09
...
module top ;
    ...
    SCB_P4_v2_0_0 UART_0 (
        .interrupt(Net_15),
        .clock(1'b0));

	wire [0:0] tmpOE__FMQ_net;
	wire [0:0] tmpFB_0__FMQ_net;
	wire [0:0] tmpIO_0__FMQ_net;
	wire [0:0] tmpINTERRUPT_0__FMQ_net;
	electrical [0:0] tmpSIOVREF__FMQ_net;

	cy_psoc3_pins_v1_10
		#(.id("25ac575d-fe81-4384-82bd-01f3ec92fa56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		FMQ
		 (.oe(tmpOE__FMQ_net),
		  .y({Net_28}),
		  .fb({tmpFB_0__FMQ_net[0:0]}),
		  .io({tmpIO_0__FMQ_net[0:0]}),
		  .siovref(tmpSIOVREF__FMQ_net),
		  .interrupt({tmpINTERRUPT_0__FMQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FMQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
