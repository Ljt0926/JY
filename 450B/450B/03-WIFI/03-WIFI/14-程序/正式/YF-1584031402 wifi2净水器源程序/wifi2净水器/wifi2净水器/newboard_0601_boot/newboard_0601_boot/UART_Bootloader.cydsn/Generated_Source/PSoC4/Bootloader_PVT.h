...
/* Packet framing constants. */
#define Bootloader_SOP            (0xFAu)    /* Start of Packet */
#define Bootloader_SOP_0            (0xFBu)    /* Start of Packet */
#define Bootloader_DATAOFFSET 		(0x21)    /* Start of Packet */
//#define Bootloader_EOP            (0x17u)    /* End of Packet */
...
/* Bootloader command definitions. */
#define Bootloader_COMMAND_SYNC         (0xCCD1u)    /* Sync the bootloader and host application           */
#define Bootloader_COMMAND_PROGRAM      (0xCCD2u)    /* Program the specified row                          */
#define Bootloader_COMMAND_PROGRAM      (0xCCD2u)    /* Program the specified row                          */
...
*******************************************************************************/
#define Bootloader_SOP_ADDR             (0x00u)         /* Start of packet offset from beginning     */
#define Bootloader_CMD_ADDR             (0x06u)         /* Command offset from beginning             */
#define Bootloader_SIZE_ADDR            (0x08u)         /* Packet size offset from beginning         */
#define Bootloader_DATA_ADDR            (0x0au)         /* Packet data offset from beginning         */
#define Bootloader_CHK_ADDR(x)          (0x0au + (x))   /* Packet checksum offset from end           */
//#define Bootloader_EOP_ADDR(x)          (0x06u + (x))   /* End of packet offset from end             */
#define Bootloader_MIN_PKT_SIZE         (7u)            /* The minimum number of bytes in a packet   */
/*******************************************************************************
...
#define Bootloader_SIZEOF_COMMAND_BUFFER      (300u)
